        ...
        bot.API.guild.userList(session.guildId)
            ...
            .finally(async function () {
                ...
                if (session.args[0] && session.args[1] && session.args[2]) {
                    ...
                    switch (arg2) {
                        ...
                        case 4:
                            ...
                            bot.axios.post('https://www.kaiheila.cn/api/v3/blacklist/create', {
                                ...
                                bot.axios.post('https://www.kaiheila.cn/api/v3/blacklist/delete', {
                                    'guild_id': session.guildId,
                                    'target_id': id
                                })
                            })
                    ...
                    console.log(new Card().addTitle('处罚公示').addText('被处罚用户ID：' + id).addText('处罚：' + penalize).setTheme('danger').toString())
