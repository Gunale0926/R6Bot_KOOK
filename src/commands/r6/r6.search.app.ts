                ...
                .then(function() {
                    ...
                    axios
                        ...
                        .then(function(res: any) {
                            var result: any =
                                res.data.players[
                                Object.keys(res.data.players)[0]
                                ];
                            if (!result) {
                                return;
                            }
                            time = (
                                result.generalpvp_timeplayed / 3600
                            ).toFixed(2);
                            kd = (
                                result.generalpvp_kills /
                                result.generalpvp_death
                            ).toFixed(2);
                            WLratio = (
                                result.generalpvp_matchwon /
                                result.generalpvp_matchplayed
                            ).toFixed(2);
                        })
                        .then(function() {
